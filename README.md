...
## Особенности
- Поддержка `title-tag`, миниатюр, кастомного логотипа, меню, сайдбара и цветовых настроек (акцент, шапка, футер, hero-палитра).
