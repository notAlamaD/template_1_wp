...
- Логика темы вынесена в папку `inc/`: `setup.php` (базовая инициализация, меню, виджеты), `assets.php` (CSS/JS + inline-переменные), `customizer.php` (настройки), `demo-content.php` (импорт демо) и `helpers.php` (вспомогательные функции).
