...
- `page-tags.php` — индекс всех тегов (по 50 на страницу) в виде карточек.
...
- Шаблон **Tag Index** (`page-tags.php`) строит сетку всех тегов по 50 штук на страницу с пейджингом.
