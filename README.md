...
3. В «Настройки → Настроить» загрузите логотип, задайте акцентный цвет, цвета шапки и футера, настройте категории и количество карточек для hero-блока, заполните текст футера и ссылки на соцсети/RSS (иконки выводятся только при наличии ссылок). При необходимости добавьте пользовательские скрипты в `<head>`.
