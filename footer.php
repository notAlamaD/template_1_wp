...
<footer class="site-footer footer-variant-<?php echo esc_attr($footer_variant); ?>">
    <div class="footer-inner">
        ...
        $social_icons = [
            ...
            'telegram'  => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21.8 4.2a1 1 0 0 0-1.1-.1L3.7 12.4a.8.8 0 0 0 .1 1.5l4.5 1.4 1.4 4.3a.8.8 0 0 0 1.3.4l2.6-2.3 3.8 2.7a.9.9 0 0 0 1.4-.6L22 5.3a1 1 0 0 0-.2-1.1zM8.7 13.8l8.3-5-6.1 6.6-.3 2.6-.7-2.2z"/></svg>',
